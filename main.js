...
class Render {
  ...
  renderMessageToChat(message, user) {
    ...
    const time = moment_default()().local("ru").format("HH:mm DD.MM.YYYY");
    newMess.innerHTML = `
...
;// CONCATENATED MODULE: ./src/js/ConnectionAPI.js
class Connection {
  constructor(url) {
...
const baseUrl = "my-little-chat.onrender.com";
// const baseUrl = "192.168.1.108:7070";

const app = new App('#app', baseUrl);
